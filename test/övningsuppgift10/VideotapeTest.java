...
public class VideotapeTest {
    ...
    Duration fortyMinutes = Duration.between(LocalTime.parse("14:10"), LocalTime.parse("14:50"));
    Duration sixtyMinutes = Duration.between(LocalTime.parse("16:10"), LocalTime.parse("17:10"));
